...
【**代码位置：****[D:\\Desktop\\KG\_allprocess\\KG\_tools](KG_tools)**】

| 序号 |                对应功能                | 对应代码 |               输入/输出文件               |
| :----: | :--------------------------------------: | :--------: | :------------------------------------------: |
|  ①  |         PDF通过OCR技术提取文本         |     [Step1_pdf_to_text.py](KG_tools\Step1_pdf_to_text.py)     |              输入：[第一讲.pdf](KG_files\第一讲.pdf)<br />输出：[第一讲_ocr.txt](file://D:\Desktop\KG_allprocess\KG_files\Output_files\Step1_output\第一讲_ocr.txt)<br />              |
