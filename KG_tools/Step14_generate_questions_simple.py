...
from pipeline_config import STEP12_NODES_TSV, STEP12_EDGES_TSV, STEP2_SENT_TSV
from pipeline_config import STEP14_Q_TSV, PROMPT_PATH
...
NODES_TSV = str(STEP12_NODES_TSV)
EDGES_TSV = str(STEP12_EDGES_TSV)
