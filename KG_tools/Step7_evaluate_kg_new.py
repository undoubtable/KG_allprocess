...
from pipeline_config import STEP4_NODES_TSV, STEP4_EDGES_TSV, STEP7_KG_QUALITY_CSV, STEP7_KG_QUALITY_JSON

NODE_TSV = str(STEP4_NODES_TSV)
EDGE_TSV = str(STEP4_EDGES_TSV)

OUTPUT_CSV = str(STEP7_KG_QUALITY_CSV)
OUTPUT_JSON = str(STEP7_KG_QUALITY_JSON)
