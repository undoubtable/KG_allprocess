...
from pipeline_config import STEP15_EVAL_TSV, STEP15_EVAL_JSON, STEP14_Q_TSV
...
try:
    ...
    _KG_NODES_TSV = STEP12_NODES_TSV
    _KG_EDGES_TSV = STEP12_EDGES_TSV

INPUT_Q_TSV = str(STEP14_Q_TSV)
OUTPUT_EVAL_TSV = str(STEP15_EVAL_TSV)
