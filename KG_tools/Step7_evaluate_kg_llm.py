...
from pipeline_config import (
    ...
    STEP45_NODES_TSV,
    STEP45_EDGES_TSV,
    STEP7_KG_QUALITY_CSV,
    STEP7_KG_QUALITY_JSON,
)
...
def main():
    # load
    b_nodes = read_tsv(str(STEP4_NODES_TSV))
    b_edges = read_tsv(str(STEP4_EDGES_TSV))
    ...
    # save
    out_csv = str(STEP7_KG_QUALITY_CSV)
    out_json = str(STEP7_KG_QUALITY_JSON)
